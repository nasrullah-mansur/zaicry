...
Route::post('/jobssearch', 'Front\JobsController@jobsSearch')->name('jobsearch');
Route::get('/jobs', 'Front\JobsController@index')->name('career');
Route::get('/apply/{id}', 'Front\JobsController@apply')->name('job.apply');
Route::get('/page/{id}', 'Front\PageController@index')->name('page.front');
Route::get('/termspage', 'Front\TermsPageController@index')->name('terms');
Route::get('/faq', 'Front\FaqController@index');
Route::get('/coming-soon', 'Front\CommingSoonController@index');
Route::get('/team', 'Front\TeamController@index')->name('team');
Route::get('/about', 'Front\AboutUsController@index')->name('about_us');
Route::get('/contact', 'Front\ContactController@index');
Route::post('/contact', 'Front\ContactController@contact')->name('contact');
...
Route::post('/comment', 'Admin\CommentController@store')->name('comment');
Route::get('/services', 'Front\ServicesController@index')->name('service');
Route::get('/services/{id}', 'Front\ServicesController@show')->name('service_detail');
Route::post('/apply/sendmail', 'Front\JobsController@mailForApply')->name('job.submit');
Route::post('/subscriber', 'Front\SubscriberController@store')->name('subscriber');
Route::get('/blog', 'Front\ShowallPostController@index');

//Auth Route
Auth::routes();
Route::get('/logout', 'Admin\CustomLogoutController@logout')->name('customlogout');

//social login
Route::get('login/{service}', 'Auth\LoginController@redirectToProvider')->name('facebook');
...
Route::group(['prefix' => 'admins', 'middleware' => 'auth'], function () {
    ...
    /*banner route*/
    Route::get('/banner/create', 'Admin\SliderController@create')->name('slider.create');
    Route::post('/banner/store', 'Admin\SliderController@store')->name('slider.store');
    Route::put('/banner/{id}/update', 'Admin\SliderController@update')->name('slider.update');
    ...
    Route::get('/servicepage/create', 'Admin\ServicePageController@create')->name('servicepage.create');
    Route::post('/servicepage/store', 'Admin\ServicePageController@store')->name('servicepage.store');
    Route::put('/servicepage/{id}/update', 'Admin\ServicePageController@update')->name('servicepage.update');

    //basic setting
    Route::get('/basicsetting/create', 'Admin\BlogPageSettingController@create')->name('basicsettings.create');
    Route::post('/basicsetting/store', 'Admin\BlogPageSettingController@store')->name('basicsettings.store');
    Route::put('/basicsetting/{id}/update', 'Admin\BlogPageSettingController@update')->name('basicsettings.update');
