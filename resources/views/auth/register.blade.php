                ...
                <div class="col-lg-6 offset-lg-6">
                    <div class="form-wrap my-5">
                        <div class="signin-top d-flex justify-content-between align-items-center">
                            <h2 class="signin-title">First Time?</h2>
                        ...
                        <div class="signin-form">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="name" name="name" placeholder="Your Name" />
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="confirm-password" name="password_confirmation" placeholder="Confirm Password" />
                                    <i class="icon fas fa-lock"></i>
                        ...
                        <div class="signin-bottom text-center">
                            ...
                            <a class="sign-button google" href="#">
                                <i class="fab fa-google"></i>Sign Up with Google
                            </a>
                            <a class="sign-button facebook" href="#">
                                <i class="fab fa-facebook"></i>Sign Up with Facebook
                            </a>
                            <p class="have-account">Allready Have An Account? <a href="{{ route('login') }}">Sign In now</a></p>
                        </div>
                    </div>
                </div>
            </div>
